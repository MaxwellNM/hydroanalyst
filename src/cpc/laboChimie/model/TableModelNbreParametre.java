 ...
 * @author MAXWELL
 */
public class TableModelNbreParametre extends AbstractTableModel {
    private String[] columnNames = { "Numlabo","type", "Date prelv labo","Date livrai", "Nbre Echantillon"};
    private Vector<Eau> eaus;

    public TableModelNbreParametre(Vector<Eau> ea) {
        this.eaus = ea;
    }
